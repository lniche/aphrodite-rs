...
SET
@ORIG_UNIQUE_CHECKS = @@UNIQUE_CHECKS;
SET
UNIQUE_CHECKS = 0;

SET
@ORIG_TIME_ZONE = @@TIME_ZONE;
SET
TIME_ZONE = '+00:00';

SET
@ORIG_SQL_MODE = @@SQL_MODE;
SET
...
DROP
DATABASE IF EXISTS `demo_rs`;
CREATE
DATABASE `demo_rs` DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_bin;
USE
`demo_rs`;
...
TRUNCATE `account`;
INSERT INTO `account` (`id`, `username`, `password`, `salt`, `role`, `realname`, `login_at`, `login_token`,
                       `created_at`, `updated_at`)
VALUES (1, 'admin', 'e03dcdf34a257041b36bd77132130fdc', 'LCV8xdTcqmkhA$ze', 2, 'Administrator', 1675941517,
        'cc3e49577201323b0010815f2485acd9', 1675941476, 1675941517);
UNLOCK
TABLES;
...
SET
FOREIGN_KEY_CHECKS = @ORIG_FOREIGN_KEY_CHECKS;

SET
UNIQUE_CHECKS = @ORIG_UNIQUE_CHECKS;
